# -*- coding: utf-8 -*-
# Generated by Django 1.11.16 on 2019-09-21 04:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_num', models.IntegerField(null=True, unique=True, verbose_name='车牌号码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_num', models.CharField(max_length=254, null=True, unique=True, verbose_name='身份证号')),
        ...
        migrations.AddField(
            model_name='list',
            name='traffic',
            field=models.ForeignKey(blank=True, db_column='bid', on_delete=django.db.models.deletion.DO_NOTHING, to='App.Bus'),
        ),
        migrations.AddField(
            model_name='car',
            name='car_uid',
